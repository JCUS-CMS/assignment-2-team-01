<?php
/**
 * Vital functions and definitions
 *
...
if ( ! function_exists( 'vital_setup' ) ) :
	...
	function vital_setup() {
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'vital' ),
		) );
...
function vital_content_width() {
	...
	$GLOBALS['content_width'] = apply_filters( 'vital_content_width', 640 );
}
...
function vital_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'vital' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'vital' ),
...
function vital_scripts() {
	wp_enqueue_style( 'vital-style', get_stylesheet_uri() );

	wp_enqueue_script( 'vital-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'vital-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );

	if ( is_singular() && comments_open() && get_option( 'thread_comments' ) ) {
		wp_enqueue_script( 'comment-reply' );
	}
}
add_action( 'wp_enqueue_scripts', 'vital_scripts' );
